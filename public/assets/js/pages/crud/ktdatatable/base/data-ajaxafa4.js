    ...
    init: function () {
        ...
        t = $("#kt_datatable").KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: HOST_URL + "/api/datatables/demos/default.php", map: function (t) {
                            var a = t;
            ...
            columns: [{
                ...
                field: "Type", title: "Type", autoHide: !1, template: function (t) {
                    ...
                    return '<span class="label label-' + a[t.Type].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + a[t.Type].state + '">' + a[t.Type].title + "</span>"
                }
            }, {
                field: "Actions",
                title: "Actions",
