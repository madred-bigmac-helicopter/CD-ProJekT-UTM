...
@section('content')
    ...
    <div class="row">
        {!! Form::open(['action' => ['App\Http\Controllers\Admin\RoleController@update', $role->id],
        'class' => 'col-4']) !!}
        <div class="form-group">
            {{ Form::label('name', 'Name', ['class' => 'awesome']) }}
            {{ Form::text('name', $role->name, ['class' => 'form-control ' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'guest']) }}
            @if ($errors->has('name'))
