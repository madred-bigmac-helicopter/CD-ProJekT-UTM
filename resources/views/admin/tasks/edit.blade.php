...
{{--                    <span class="text-danger">*</span>--}}
                ...
                <input name="name" type="text" class="form-control @if ($errors->has('name')) is-invalid @endif" placeholder="Enter task name" required value="{{$task->name}}"/>
...
{{--                    <span class="text-danger">*</span>--}}
            ...
            <div class="form-group">
                ...
                <div class="custom-file">
                    ...
                    <label class="custom-file-label selected" for="customFile">{{$task->file}}</label>
                </div>
            </div>
        </div>
