                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{route('task.create')}}" class="btn btn-primary font-weight-bolder">
            ...
            init: function () {
                ...
                t = $("#kt_datatable").KTDatatable({
                    data: {
                        ...
                        source: {
                            read: {
                                url: "/admin/tasks", map: function (t) {
                                    var a = t;
                    ...
                    columns: [
                        ...
                        {
                            field: "difficulty", title: "Difficulty", template: function (t) {
                                if (t.difficulty === 0)
                                    return 'Easy';
                                if (t.difficulty === 1)
                                    return 'Medium';
                        ...
                        {
                            field: "category", title: "Category", template: function (t) {
                                if (t.category === 0)
